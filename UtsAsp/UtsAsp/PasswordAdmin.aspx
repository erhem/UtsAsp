<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="PasswordAdmin.aspx.cs" Inherits="UtsAsp.PasswordAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        function isValidPassword() { //This function call on text change.      
            $.ajax({  
                type: "POST",  
                url: "PasswordAdmin.aspx/CheckPassword", 
